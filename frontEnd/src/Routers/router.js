...
export const NUEVO_TRAMITE = '/Nuevo_tramite';
export const NUEVO_TRAMITE_PAGO = '/Nuevo_tramitePago';
export const NUEVO_TRAMITE_EXPEDIENTES = '/Nuevo_tramiteExpediente';
